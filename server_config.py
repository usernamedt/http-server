...
class ServerConfig:
    ...
    queue_size: int = 5
    supported_methods: List[str] = ["GET"]
    supported_protos: List[str] = ["HTTP/1.1", "HTTP/1.0"]
    default_headers: Dict[str, str] = {"Server": "PythonHTTPServer/0.1b"}
    www_dir: str = "wwwroot"
    log_file: str = "log.txt"
    proxy_pass_mode: bool = False
    file_cache_size: int = 10
    file_cache_errors: bool = True
    error_page_loc: str = "general_error.html"
